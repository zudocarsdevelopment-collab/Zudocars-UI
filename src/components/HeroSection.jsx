                    ...
                    {({ openPicker, formatDate }) => (
                      <div className="space-y-3">
                        <button
                          type="button"
                          onClick={openPicker}
                          className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-3 py-2.5 text-left text-white text-xs font-medium focus:outline-none focus:border-blue-500/50 transition-colors"
                        ...
                        >
                          ...
                          <span className="flex items-center justify-center gap-3">
                            <span>
                              {formatDate(pickupDate) || "Pickup Date"}
                            </span>
                            <span className="text-gray-500">-</span>
                            <span>
                              {formatDate(dropDate) || "Drop Off Date"}
                            </span>
                          </span>
                        </button>
